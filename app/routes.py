...
def get_bot_response():
    ...
    if any(word in userText for word in disaster_words):
        help = "Searching for avaliable help ... Are are in a disaster? \
            SELECT THE DISASTER  Or met an accident " ,disasters
        msg = str(help)
    ...
    if str(userText.lower()) == "flood":
        ...
        return  """FOLLOW   THESE  TO  BE  SAFE , Mind Me
            ...
            Try to keep your cool and don't run around here and there, 
            come out of the building if you can safely.
            Tip: A doorway is the safest place to be during an earthquake
            if you have a somewhat old house!
        ...
        return """ Cyclones : Don't go outside until officially advised it is safe. 
            Check for gas leaks.  Beware of damaged POWER LINES, bridges, BUILDINGS, trees, 
            and don't enter FLOODWATER.
            REQUEST SENT :)  for your help!  DO NOT PANIC ,
            HELP ON ITS WAY!
            """

    elif str(userText.lower()) == "mudslides":    
        return """FOLLOW THESE STEPS: Move away quickly from the path of the mudflow 
            or landslide to another location. Do not try to stay close and take photographs. 
            Landslide debris move from uphill to downhill, therefore, avoid low-lying areas or valleys.
            If there is a way to sound an alarm, do so.
            Listen and look out for signs of further flows in that area,
            as the flowing debris often knock against surrounding slopes and sets off new flows.
            """
